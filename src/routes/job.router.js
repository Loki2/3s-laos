...
const { get_jobs, get_createJob, post_createJob, get_JobId, get_updateJob, post_updateJob, get_deleteJobId } = require('../controllers/job.controller')
...
router.post('/delete/:id', authenticated, get_deleteJobId);
